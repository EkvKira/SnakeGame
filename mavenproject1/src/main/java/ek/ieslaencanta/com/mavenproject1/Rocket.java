 ...
 * @author kirae
 */
public class Rocket extends Nofruit {
    private static int WIDTH = 15, HEIGHT = 15;
    private int img_x = 85;
    private int img_y = 17;

    public Rocket(Point2D posicion, Rectangle2D game_zone) {
    ...
    public void paint(GraphicsContext gc) {
        Resources r = Resources.getInstance();
             gc.drawImage(r.getImage("imagen"),
                ...
                Rocket.WIDTH * Game.SCALE,
                Rocket.HEIGHT * Game.SCALE);
    }
